...
const projects = [
  ...
  },
  {
    ...
    description:
      "Designed and developed a responsive and dynamic client database table",
    images: ["/projects/client data.png"],
    tags: ["HTML", "CSS", "JavaScript", "Tailwind css"],
     githubUrl: "https://bluez-infomatic.github.io/Data_Store/site/site.html",
  },
   {
    id: 4,
    title: "Invoice",
            ...
            {projects.map((project, idx) => (
              ...
              >
                <div
                  ...
                  className="h-48 overflow-x-auto scroll-smooth hide-scrollbar px-1 py-2"
